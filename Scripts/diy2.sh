...
if [[ $WRT_CONFIG == *"EMMC"* ]]; then
    # 有 EMMC 时，只保留：redmi_ax5-jdcloud / jdcloud_re-ss-01 / jdcloud_re-cs-02
    keep_pattern="\(redmi_ax5-jdcloud\|jdcloud_re-ss-01\|jdcloud_re-cs-02\)=y$"
else
    # 普通情况，只保留这几个
    kepattern="\(redmi_aep_x5\|qihoo_360v6\|redmi_ax5-jdcloud\|zn_m2\|jdcloud_re-ss-01\|jdcloud_re-cs-02\)=y$"
fi
