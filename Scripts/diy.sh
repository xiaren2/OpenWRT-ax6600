...
#speedtest
UPDATE_PACKAGE "luci-app-netspeedtest" "https://github.com/sirpdboy/luci-app-netspeedtest.git" "js" "pkg"
UPDATE_PACKAGE "speedtest-cli" "https://github.com/sirpdboy/luci-app-netspeedtest.git" "js" "pkg"
